...
public class RyzenBuildMaintainerPreferenceController extends BasePreferenceController {

    private static final String TAG = "RyzenBuildMaintainerCtrl";

    private String mDeviceMaintainer;

    public RyzenBuildMaintainerPreferenceController(Context context, String key) {
        super(context, key);
