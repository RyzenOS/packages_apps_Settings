...
public class RyzenSpecUtils {
    private static final String DEVICE_NAME_MODEL_PROPERTY = "ro.product.system.model";
    private static final String RYZEN_CPU_MODEL_PROPERTY = "ro.ryzen.cpu";
